...
class QueryBuilderUnitTest(unittest.TestCase):
    ...
    def test_get_level_refactorings(self):
        ...
        sqlBuilt: str = get_level_refactorings(int(Level.Class), "Change Parameter Type", "github")
        self.assertEqual(sqlExpected, sqlBuilt)
