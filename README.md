...
For this script to run, you need to create a `results/` folder. The results will be stored there.
...
For this script to run, you need to create a `results/` folder. The final CSV will be stored there. The header of the
CSV is clear.
